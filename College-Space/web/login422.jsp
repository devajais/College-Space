...
<body class="text-center">
  <main class="form-signin">
      ...
      <form action="bietFaculty.jsp" method="post">
      <h1 class="h3 mb-3 fw-normal" style="
      font-family: 'Overpass', sans-serif;">Admin Login</h1>
      <div class="form-floating">
          <select name="AdminType" class="form-control" id="floatingInput" required>
